...
public class KFCTest_MultiDevices {
...
//	public static void main(String[] args) throws InterruptedException, IOException {}
	...
	public void MakeAnOrderWithoutLogin() throws InterruptedException, IOException {
		try {
			...
			MobileElement changeButton = (MobileElement) wait.until(ExpectedConditions.elementToBeClickable(driver.findElementByAccessibilityId("Change")));
			changeButton.click();
	...
	/*------------------------- Flow For Selecting Type and Location -------------- */		
			...
			MobileElement xpath_DineIn = (MobileElement) wait.until(ExpectedConditions.elementToBeClickable(driver.findElementByAccessibilityId("Dine In")));
			xpath_DineIn.click();
			xpath_DineIn.click();
			...
			MobileElement location_Selector = (MobileElement) wait.until(ExpectedConditions.elementToBeClickable(driver.findElementByXPath(
					"(//android.widget.TextView[@content-desc=\"Nadaun, Himachal Pradesh, India\"])[1]")));
			location_Selector.click();

			MobileElement order_forLocation = (MobileElement) wait.until(ExpectedConditions.elementToBeClickable(driver
...
//			el2.click();
			...
			MobileElement add_toCartButton = (MobileElement) wait.until(ExpectedConditions.elementToBeClickable(driver
			...
			MobileElement checkout_button = (MobileElement) wait.until(ExpectedConditions.elementToBeClickable(driver.findElementByXPath(
...
//					.findElementByXPath("(//android.widget.EditText[@content-desc=\", \"])[1]");
			MobileElement cust_name = (MobileElement) wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//android.widget.EditText[@content-desc=\", \"])[1]")));
			...
			MobileElement add_payment_type = (MobileElement) wait.until(ExpectedConditions.elementToBeClickable(driver.findElementByXPath(
			...
			MobileElement cash_option = (MobileElement) wait.until(ExpectedConditions.elementToBeClickable(driver.findElementByXPath(
			...
			cash_option.click();
			MobileElement payment_submit = (MobileElement) wait.until(ExpectedConditions.elementToBeClickable(driver.findElementByXPath(
			...
			MobileElement place_Order = (MobileElement) wait.until(ExpectedConditions.elementToBeClickable(driver
					.findElementByXPath("//android.widget.Button[contains(@content-desc,'Place Order')]")));
			place_Order.click();

			Thread.sleep(20000);

			MobileElement el34 = (MobileElement) wait.until(ExpectedConditions.elementToBeClickable(driver
